#ifndef HALIDE______third_party___halide___libs___arm64___v8a___ud_preprocess_aot_h
#define HALIDE______third_party___halide___libs___arm64___v8a___ud_preprocess_aot_h
#include <stdint.h>
...
int ud_preprocess_aot(struct halide_buffer_t *_y_plane_buffer, struct halide_buffer_t *_uv_plane_buffer, int32_t _is_nv21, int32_t _rotation, int32_t _in_w, int32_t _in_h, struct halide_buffer_t *_out_buffer);

HALIDE_FUNCTION_ATTRS
int ud_preprocess_aot_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *ud_preprocess_aot_metadata();
