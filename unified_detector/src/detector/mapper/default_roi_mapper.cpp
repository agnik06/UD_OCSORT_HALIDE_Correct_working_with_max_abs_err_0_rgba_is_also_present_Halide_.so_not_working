...
std::vector<unified_detector::BoundingBox> DefaultROIMapper::map(std::vector<unified_detector::BoundingBox> boxes){
    boxes = assign_labels(boxes);
    return boxes;
}

std::vector<unified_detector::BoundingBox> DefaultROIMapper::assign_labels(std::vector<unified_detector::BoundingBox> boxes){
