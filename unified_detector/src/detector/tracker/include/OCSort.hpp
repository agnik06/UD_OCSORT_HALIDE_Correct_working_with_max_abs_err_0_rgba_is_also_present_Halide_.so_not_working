...
namespace ocsort {
    ...
    public:
        ...
        // Cached working matrices reused across update() calls — avoid 4 heap
        // allocations per frame. Eigen resize() reuses storage if capacity fits.
        Eigen::MatrixXf cached_trks_;
        Eigen::MatrixXf cached_velocities_;
        Eigen::MatrixXf cached_last_boxes_;
        Eigen::MatrixXf cached_k_observations_;
    };
