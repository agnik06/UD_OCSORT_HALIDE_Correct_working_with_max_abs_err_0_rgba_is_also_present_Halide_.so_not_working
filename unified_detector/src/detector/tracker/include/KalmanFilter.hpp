...
namespace ocsort {
    ...
    public:
        ...
        const Eigen::Matrix<float, 7, 7> I = Eigen::Matrix<float, 7, 7>::Identity();
        ...
        Eigen::Matrix<float, 7, 1> x_prior;
        Eigen::Matrix<float, 7, 7> P_prior;
        // there will always be a copy of x,P after update() is called
        Eigen::Matrix<float, 7, 1> x_post;
        Eigen::Matrix<float, 7, 7> P_post;
