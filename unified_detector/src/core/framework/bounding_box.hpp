...
public:
    ...
    BoundingBox(){
        ...
        this->tag_id = -1;
        this->trackid = -1;
        this->isSceneCategory = false;
        this->isObjectCategory = false;
    }
    BoundingBox(Rectangle box_location, Size image_size, std::string box_tag, float box_score, int tag_id, int track_id = -1, bool isSceneCategory = false, bool isObjectCategory = false){
        ...
        this->isSceneCategory = isSceneCategory;
        this->isObjectCategory = isObjectCategory;
    ...
    void set(const BoundingBox& bbox){
        ...
        this->isSceneCategory = bbox.isSceneCategory;
        this->isObjectCategory = bbox.isObjectCategory;
    }
};
} // viz
