...
public class Utils {
    ...
    {
        Log.i("Unified Detector Utils", "Decoding Image ...");
        ...
        Log.i("Unified Detector Utils", "Decoding Image completed sucessfully.");
        return null;
    ...
    public static ArrayList<DetectorBoxInfo> convert_result_info_to_box_entities(String json_str) {
        Log.d("Unified Detector Utils","convert_result_info_to_box_entities");
        try {
            ArrayList<DetectorBoxInfo> entities = new ArrayList<>();
            ...
            for(int i=0; i<arr_reader.length(); i++){
                ...
                Log.e("Unified Detector Utils","Tag : "+tag+" TAGId : "+tagId+ " Score : "+score+",left : "+left+",top : "+top+",right : "+right+",bottom : "+bottom);

                entities.add(new DetectorBoxInfo(tag, tagId,left,top,right,bottom,score));
            }
            Log.d("Unified Detector Utils","exit convert_result_info_to_box_entities");
            return entities;
