...
ENGINE_BASE_PATH 				:= $(LOCAL_PATH)/../../../../image_segmentation
...
IMAGE_SEGMENTER_INCLUDE := $(ENGINE_BASE_PATH)/include/image_segmentation
...
LOCAL_MODULE := SemanticMap_v1.camera.samsung
LOCAL_ARM_MODE := arm
...
LOCAL_CFLAGS += -D__SM_SEG_VERSION__='"v1.5"'
...
LOCAL_SHARED_LIBRARIES += OPENCV_HQ
LOCAL_SHARED_LIBRARIES += SemanticMap_v1.camera.samsung
LOCAL_SHARED_LIBRARIES += STL_LIBC++
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/jni_wrapper_utils.cpp $(LOCAL_PATH)/ImageSegmenterJNI.cpp
include $(BUILD_SHARED_LIBRARY)
...
#ifeq ($(TARGET_ARCH_ABI), arm64-v8a)
#include $(CLEAR_VARS)
#LOCAL_MODULE := SemanticMap_v1_HWASAN.camera.samsung
#LOCAL_ARM_MODE := arm
...
#LOCAL_CFLAGS += -D__android__
#LOCAL_CFLAGS += -D__ISEG_VERSION__='"v1"'
#LOCAL_CFLAGS += -D__AF_SEG_VERSION__='"v1.9_HWASAN"'
...
#ifeq ($(TARGET_ARCH_ABI), arm64-v8a)
#include $(CLEAR_VARS)
#LOCAL_MODULE := SceneSegmenterJNI_HWASAN
#LOCAL_ARM_MODE := arm
