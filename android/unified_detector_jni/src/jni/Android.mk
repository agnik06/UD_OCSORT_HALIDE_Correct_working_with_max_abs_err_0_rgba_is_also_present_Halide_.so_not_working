...
#------------------------------------------------------
# RGBA Halide pipeline: cvtColor (ud_rgba2bgr) + cv::resize + rotate+normalize
# (ud_rotate_normalize). Both libs are emitted no_runtime; they share the
# Halide runtime carried by libud_preprocess_aot.a above -- keep all three
# linked together.
include $(CLEAR_VARS)
...
# ifeq ($(TARGET_ARCH_ABI), arm64-v8a)
	...
	# LOCAL_CFLAGS += -DDLINTERFACELIBLOCATION_SYSTEM='"/system/lib64/libDLInterface_aidl.camera.samsung.so"'
...
# else
	...
	# LOCAL_CFLAGS += -DDLINTERFACELIBLOCATION_SYSTEM='"/system/lib/libDLInterface_aidl.camera.samsung.so"'
...
FILE_LIST += $(wildcard $(ENGINE_SRC_PATH)/**/**/**/*.cpp)
FILE_LIST += $(wildcard $(ENGINE_SRC_PATH)/**/**/**/**/*.cpp)
#FILE_LIST += $(wildcard $(ENGINE_SRC_PATH)/**/**/*.c)
...
#LOCAL_SRC_FILES := $(wildcard $(ENGINE_SRC_PATH)/**/**/*.c) $(LOCAL_PATH)/jni_wrapper_utils.cpp $(LOCAL_PATH)/ImageSegmenterJNI.cpp
include $(BUILD_SHARED_LIBRARY)